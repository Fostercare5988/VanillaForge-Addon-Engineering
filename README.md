...
[![ClassicAPI](https://img.shields.io/badge/ClassicAPI-v1.15.10%2B-brightgreen.svg)](https://github.com/brues-code/ClassicAPI)
...
| --- | --- | --- |
| [ClassicAPI](https://github.com/brues-code/ClassicAPI) | **v1.15.10+** | Modern/backported WoW API, Lua compatibility, events, unit tokens, secure-style helpers, timers and modern client behavior |
