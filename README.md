...
[![ClassicAPI](https://img.shields.io/badge/ClassicAPI-v1.15.14%2B-brightgreen.svg)](https://github.com/brues-code/ClassicAPI)
...
| --- | --- | --- |
| [ClassicAPI](https://github.com/brues-code/ClassicAPI) | **v1.15.14+** | Modern/backported WoW API, Lua compatibility, events, unit tokens, secure-style helpers, timers and modern client behavior |
...
every existing addon to set `MIN_CLASSIC_API=11514`. See the
[v1.15.14 audit](docs/CLASSICAPI_1.15.14_AUDIT.md) for current provenance, semantic
