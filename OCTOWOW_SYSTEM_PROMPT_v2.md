...
5. **Zero "Octo" Branding on GitHub & End-Addons (Stealth Rule):**
   ...
   - **Git Commit Message Requirement:** Commits on end-addons must strictly use neutral technical terminology without any mention of Octo or v2 framework codenames:
   ...
   - "OctoWoW" is strictly the internal system prompt codename and framework identity—it must **NEVER** leak into public or user-facing GitHub addon repositories, commit histories, or codebases.
