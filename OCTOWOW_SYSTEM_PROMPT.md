...
- **Mandatory Sections in Every `README.md`**:
  1. **Header & Badges**: Version (`x.x.x`), Interface (`1.12.1 (Build 5875)`), Engine (`ClassicAPI v1.13.3+ | SuperWoW v2.2+ | NamPower v4.6.2+ | UnitXP SP3 | DXVK`), License (`MIT` or original).
  2. **Description**: Concise summary of what the addon does and how it leverages the Enhanced 1.12.1 Engine Stack (**ClassicAPI v1.13.3+**, **SuperWoW v2.2+**, **NamPower 4.6.2+**, **UnitXP SP3**, **DXVK**).
